...
import { defineInstanceFunction, type BamlCallContext } from "@boundaryml/baml-bridge";
 ...
 */
  root_cause = defineInstanceFunction("baml.errors.ErrorContext.root_cause", "sync", ["self"]).bind(this) as ($opts?: { $ctx?: BamlCallContext | undefined } | undefined) => ErrorContext;
/**
 * The original error at the tail of the cause chain — walks `cause` to the
 * deepest link. Returns `self` when nothing was superseded.
 */
  root_cause_async = defineInstanceFunction("baml.errors.ErrorContext.root_cause", "async", ["self"]).bind(this) as ($opts?: { $ctx?: BamlCallContext | undefined } | undefined) => Promise<ErrorContext>;
  _to_string_impl = defineInstanceFunction("baml.errors.ErrorContext._to_string_impl", "sync", ["self"]).bind(this) as ($opts?: { $ctx?: BamlCallContext | undefined } | undefined) => string;
  _to_string_impl_async = defineInstanceFunction("baml.errors.ErrorContext._to_string_impl", "async", ["self"]).bind(this) as ($opts?: { $ctx?: BamlCallContext | undefined } | undefined) => Promise<string>;
}
...
export class StackTrace {
  ...
  _to_string_impl = defineInstanceFunction("baml.errors.StackTrace._to_string_impl", "sync", ["self"]).bind(this) as ($opts?: { $ctx?: BamlCallContext | undefined } | undefined) => string;
  _to_string_impl_async = defineInstanceFunction("baml.errors.StackTrace._to_string_impl", "async", ["self"]).bind(this) as ($opts?: { $ctx?: BamlCallContext | undefined } | undefined) => Promise<string>;
}

/**
 * Universal wrapper for errors that do not implement a known capability channel.
 */
export class UnknownError$stream {
  data!: unknown;
  message!: string[];
  constructor(init: {
    data: unknown;
