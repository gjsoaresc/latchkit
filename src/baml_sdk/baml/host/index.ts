 ...
 */
export const call_host_value = defineFunction("baml.host.call_host_value", "sync", ["handle", "args"], undefined, { typeParams: ["T", "E"] }) as <T, E>(handle: HostValue, args: unknown[], $opts?: { $ctx?: BamlCallContext | undefined; $types?: { T?: BamlType | BamlTypeToken; E?: BamlType | BamlTypeToken } | undefined } | undefined) => T;
 ...
 * callee type on the wire.
 */
export const call_host_value_async = defineFunction("baml.host.call_host_value", "async", ["handle", "args"], undefined, { typeParams: ["T", "E"] }) as <T, E>(handle: HostValue, args: unknown[], $opts?: { $ctx?: BamlCallContext | undefined; $types?: { T?: BamlType | BamlTypeToken; E?: BamlType | BamlTypeToken } | undefined } | undefined) => Promise<T>;
