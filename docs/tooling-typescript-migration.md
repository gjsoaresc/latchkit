...
The archive, atomic-publish, bundle, release-artifact, artifact-smoke,
bundle-smoke, and release-evidence tools are strict TypeScript sources emitted
under `dist/scripts/`; their callers invoke the emitted files.
...
- `scripts/clean.js`, `live-lifecycle-evidence.js`,
  `live-provider-adapter-evidence.js`, `live-workflow-evidence.js`,
  `provider-e2e.js`,
