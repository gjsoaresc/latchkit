...
> Current package candidate: source commit `b12483fe449dcdd21bdcb2013ecbeafe3131f9c3`, packaged locally without publication as `latchkit-1.0.0-rc.1.tgz` with SHA-256 `7c2bab36b27f8928afffe2bc28c38595658dd4e91d04c5fa03864c948dafb682`.

## Candidate and decision

- Package: `latchkit@1.0.0-rc.1`
- Package source commit: `b12483fe449dcdd21bdcb2013ecbeafe3131f9c3`
- Exact archive SHA-256: `7c2bab36b27f8928afffe2bc28c38595658dd4e91d04c5fa03864c948dafb682`
- Qualification date: 2026-09-06 UTC
- Decision: **NO-GO** for v1.0 publication

The maintainer selected an explicit release-candidate version. The exact candidate now passes the complete live Codex requirements-to-handoff scenario, including interruption recovery, implementation, verification, resumable handoff, and independent review. The candidate is not yet eligible for a production-ready claim because the updated Cursor IDE event-only evidence mode still requires one manual editor rerun. Issue #36 must remain open. No tag, GitHub release, registry publication, or stable-version claim has been made.
...
| [Merged main CI](https://github.com/willahealm/latchkit/actions/runs/34003943892) | Node 22/24 on Windows, Ubuntu, and macOS; Chromium, Firefox, WebKit; real WSL | All jobs passed on the merged package source commit |
...
| Cursor IDE | Native Windows | Skill discovery and the bounded one-file editor workflow passed on the earlier RC, but the updated privacy-safe event-only evidence mode still needs one manual rerun on the current exact archive | **blocked** |
...
1. Rerun the documented Cursor IDE manual workflow on the exact current archive and retain only the bounded event names, counts, and classifications produced by the opt-in evidence mode.
2. Review the completed matrix, security findings, package inventory, documentation, and limitations. Only then may the maintainer authorize a fresh controlled release dry run, the RC tag, and the publication workflow.
